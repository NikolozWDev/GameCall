    ...
    <div className="min-h-screen bg-[#04070E] selection:bg-[#0F7C9D]/30 cursor-default">
      <div className="bg-[#04070E]">
        <section className="w-full h-[55vh] md:h-[65vh] relative mt-0 pt-0 overflow-hidden group">
          ...
          <FadeInSection className="relative z-10 container mx-auto max-w-6xl px-4 md:px-8 h-full flex flex-col items-center justify-center text-center">
            <h1 className="text-3xl md:text-6xl font-extrabold mb-4 md:mb-6 leading-tight tracking-tight drop-shadow-2xl">
            ...
            <p className="text-white/90 text-sm md:text-base max-w-md mx-auto mb-6 md:mb-8 leading-relaxed drop-shadow-lg px-4">
              Create a room in seconds. Share a link. Talk instantly. No downloads.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 md:gap-4">
              <Button
                size="lg"
                className="w-full sm:w-auto bg-[#0F7C9D] hover:bg-[#0E6A87] text-white px-6 md:px-7 py-4 md:py-5 text-sm md:text-base font-semibold rounded-xl shadow-xl shadow-[#0F7C9D]/40 hover:shadow-2xl hover:shadow-[#0F7C9D]/50 active:scale-95 cursor-pointer transition-all duration-300"
                onClick={() => isAuthenticated ? setShowCreateModal(true) : setAuthView("login")}
              >
                <ZapIcon className="h-4 w-4 md:h-5 md:w-5 mr-2" />
                Create Room
              </Button>
              <Button
                size="lg"
                className="w-full sm:w-auto bg-[#5DAEC4]/20 text-white border border-[#5DAEC4]/60 shadow-lg shadow-[#5DAEC4]/30 hover:bg-[#0F7C9D] hover:text-white hover:border-[#0F7C9D] hover:shadow-xl hover:shadow-[#0F7C9D]/40 px-6 md:px-7 py-4 md:py-5 text-sm md:text-base font-semibold rounded-xl active:scale-95 cursor-pointer transition-all duration-300"
